...
//       }}
//       className={`px-6 py-4 hover:bg-white/[0.02] cursor-pointer transition-colors relative`}
//     >
//       <div className="flex gap-4">
//         <div 
//           style={{ backgroundColor: 'var(--bg-deep)', borderColor: 'var(--border-main)' }}
//           className="w-11 h-11 rounded-full overflow-hidden shrink-0 border"
//         >
//           <img
//             src={n.avatar && n.avatar.trim() !== "" ? n.avatar : defaultAvatar}
//             alt=""
...
//         <div className="flex-1" onClick={handleItemClick}>
//           <p style={{ color: 'var(--text-main)' }} className="text-sm leading-snug">
//             <span className="font-bold">{n.employeeName}</span>{" "}
//             {n.message}
//           </p>
//           <p style={{ color: 'var(--text-muted)' }} className="text-[11px] font-medium mt-1">{n.time}</p>
...
//                     className="text-[11px] px-5 py-1.5 rounded-full font-bold border border-transparent hover:border-red-500/30"
//                   >
//                     Decline
//                   </button>
//                 </motion.div>
...
//                 dispatch(markAsRead(n.id));
//               }}
//               style={{ backgroundColor: n.status === "read" ? 'rgba(2, 147, 250, 0.1)' : 'var(--bg-deep)' }}
//               className={`w-6 h-6 rounded-full flex items-center justify-center transition-all ${n.status === "read" ? "text-blue-500" : "text-gray-500"}`}
//             >
//               <i className="fas fa-check text-[10px]"></i>
//             </button>
//           ) : (
...
//                 setIsExpanded(!isExpanded);
//               }}
//               style={{ backgroundColor: isExpanded ? 'rgba(2, 147, 250, 0.1)' : 'var(--bg-deep)' }}
...
//             className="absolute right-0 mt-4 w-[400px] border rounded-[2rem] shadow-2xl z-50 overflow-hidden backdrop-blur-xl"
//           >
//             <div 
//               style={{ borderBottom: '1px solid var(--border-main)' }}
//               className="p-6 flex justify-between items-center"
//             >
//               <h3 style={{ color: 'var(--text-main)' }} className="font-bold">
//                 Notifications{" "}
//                 <span className="bg-pink-500/20 text-pink-500 text-[10px] px-2 py-0.5 rounded-full">
//                   {unreadCount}
//                 </span>
...
//                 )
//               ) : (
//                 <div style={{ color: 'var(--text-muted)' }} className="py-20 text-center text-sm">
//                   No new notifications
//                 </div>
//               )}
//             </div>
