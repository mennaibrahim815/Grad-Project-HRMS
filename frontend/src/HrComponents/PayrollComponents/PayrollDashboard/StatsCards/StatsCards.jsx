...
const StatsCards = ({ stats }) => {
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
    {cards.map((card, i) => (
      ...
      >
        <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest mb-4 truncate">
          {card.title}
        </p>

        <h2 className="text-xl sm:text-2xl lg:text-3xl font-black text-white mb-4 truncate">
