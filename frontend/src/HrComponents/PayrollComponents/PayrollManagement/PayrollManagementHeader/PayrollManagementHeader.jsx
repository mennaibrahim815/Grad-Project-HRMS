            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="flex items-center gap-2 justify-end w-full lg:w-auto">
                    <button
                        ...
                        className="font-bold border w-10 h-10 sm:w-auto sm:h-auto sm:px-4 sm:py-2.5 rounded-full sm:rounded-xl flex items-center justify-center sm:gap-2 hover:opacity-80 transition-all text-sm shrink-0"
                    >
                        <CreditCard size={15} />
