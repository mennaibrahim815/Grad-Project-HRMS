  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4">
        {data.photoPreview ? (
          <img src={data.photoPreview} alt="employee" className="h-16 w-16 rounded-full object-cover border border-white/10" />
        ) : (
          ...
          {['Male', 'Female'].map((g) => (
            <label
              ...
              className={`flex cursor-pointer items-center gap-3 rounded-xl px-4 py-3 border transition
                ${data.gender === g ? 'border-blue-500 bg-white/5 text-blue-500' : 'border-white/10 bg-white/5 text-gray-400 hover:border-white/20'}`}
            >
              <input
                type="radio"
                name="gender"
                ...
                className="hidden"
              />
              <span className={`flex h-4 w-4 items-center justify-center rounded-full border ${data.gender === g ? 'border-blue-500' : 'border-gray-500'}`}>
