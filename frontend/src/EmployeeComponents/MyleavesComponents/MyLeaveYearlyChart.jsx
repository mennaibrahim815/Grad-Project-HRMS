...
//   return (
//     <div className="w-full bg-[#0c1922] border border-slate-800/80 rounded-[2rem] p-6 shadow-2xl relative leaves-chart-override box-border transition-all duration-300">
