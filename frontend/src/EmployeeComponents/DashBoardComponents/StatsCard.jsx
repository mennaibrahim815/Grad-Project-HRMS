...
//   return (
//     <div 
//       style={{ backgroundColor: 'linear-gradient(to bottom right, var(--card-from) 0%, var(--card-to) 100%)', borderColor: 'var(--border-main)' }}
//       className="p-5 rounded-2xl border transition-all hover:shadow-md group"
//     >
//       <div className="flex justify-between items-start mb-4">
//         {/* خلفية الأيقونة تأخذ الكلاس الممرر (مثل bg-blue-600) وتبقى ثابتة */}
