...
// import { Check, X, Loader2, AlertCircle, Clock, Download, Calendar } from "lucide-react";
...
//         // فلترة التاسكات من البداية: نأخذ فقط التاسكات التي تحتوي على ملف مرفوع فعلياً
...
//       alert(`Task has been ${actionType === 'accept' ? 'Accepted' : 'Rejected'} successfully!`);
//     } catch (err) {
...
export default function HrTasksPage() {
  ...
  return (
    <div className="p-6 bg-[#0f172a] min-h-screen text-slate-100 relative">
      {/* Header */}
      <div className="flex flex-col gap-2 mb-8">
        <h1 className="text-2xl font-bold tracking-tight text-white flex items-center gap-2">
          <Clock className="text-cyan-400" /> On-going Tasks Review
