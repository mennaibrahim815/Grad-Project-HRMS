        ...
        >
          <div className="w-full max-w-md">
            ...
            >
              ...
              <span style={{ color: 'var(--text-main)' }} className="text-xl font-bold tracking-tight italic">
            ...
            >
              <Link
                ...
                className="hover:opacity-80 text-sm flex items-center gap-2 mb-6 transition-all group w-fit"
              >
            ...
            <form onSubmit={handleSendCode} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3.5 rounded-xl border outline-none transition-all ${
                    error
              ...
              <motion.button
                ...
                className={`w-full p-4 rounded-xl font-bold transition-all flex justify-center items-center h-12 shadow-lg ${
                  loading
                    ? "bg-slate-700/50 cursor-not-allowed text-gray-500"
        ...
        >
          ...
          >
            <motion.h2
              ...
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: 0.6 }}
              className="text-4xl font-bold mb-4 z-10 leading-tight text-white"
            >
